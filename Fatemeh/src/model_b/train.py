...
# src/model_b/train.py
# Model B: fine-tuning (train head + backbone).
...
def main() -> None:
    ...
    parser.add_argument("--config", type=str, default="configs/model_b.yaml", help="Path to YAML config.")
    ...
    # Model B: backbone NOT frozen (fine-tuning)
    ...
    # IMPORTANT: fine-tuning trains ALL trainable parameters
